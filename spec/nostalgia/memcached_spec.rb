...
describe 'Nostalgia::Memcached' do
  ...
  describe ' instance stats' do
    ...
    it 'should correctly calculate the ratio_of_sets_to_gets' do
      @memcached_instance.ratio_of_sets_to_gets.must_equal(23010340/ 2914756157)
    end 

    it 'should have  correct ratio of hits_to_misses' do
      @memcached_instance.ratio_of_hits_to_misses.must_equal(626258184 /288497973)
    end

    it 'should correctly calculate the ratio of writes to reads' do
      @memcached_instance.ratio_of_bytes_written_to_bytes_read.must_equal(2121241633323 / 9881626616521)
    end

    it 'should correctly calculate the ratio of reclaimed items to evicted items' do
      @memcached_instance.ratio_of_reclaimed_items_to_evicted_items.must_equal(7708332 / 220424478)
    end

    it 'should correctly calculate the ratio of evicted_items_to_total_items' do
      @memcached_instance.ratio_of_evicted_items_to_total_items.must_equal( 220424478 / 230103335 )
    end
  end
